...
public class StoreAdapter extends BaseAdapter {
    ...
    public StoreAdapter(Context cont, ArrayList<Store> data)
    {
...
//        imageLoader.destroy();
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View root = inflater.inflate(R.layout.shop_item,null);
        TextView shop_name = (TextView)root.findViewById(R.id.near_me_shop);
        ImageView shop_image = (ImageView)root.findViewById(R.id.near_me_shop_image);

        shop_name.setText(result.get(i).getStore_name());
        imageLoader.displayImage(result.get(i).getStore_url(),shop_image);
