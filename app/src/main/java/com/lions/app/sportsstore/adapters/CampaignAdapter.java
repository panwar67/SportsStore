...
public class CampaignAdapter extends BaseAdapter {
    ...
    private final ArrayList<Campaigns> result;

    LayoutInflater inflater = null;
    ImageLoader imageLoader;
    DisplayImageOptions options;

    public CampaignAdapter(Context cont, ArrayList<Campaigns> data)
    {
        context = cont;
        result = data;
...
//        imageLoader.destroy();
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View root = inflater.inflate(R.layout.camp_item,null);
        ImageView imageview = (ImageView)root.findViewById(R.id.camp_image);
